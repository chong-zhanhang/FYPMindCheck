...
public class TherapistAppointmentPendingFragment extends Fragment {
    private RecyclerView recyclerView;
    private AppointmentAdapter appointmentAdapter;
    private List<AppointmentsUpcomingFragment.Appointment> appointments;
    public TherapistAppointmentPendingFragment() {
    ...
    public class AppointmentAdapter extends RecyclerView.Adapter<AppointmentAdapter.ViewHolder> {
        ...
        public AppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_therapist_pending_appointment, parent, false);
            ...
            public void bind(AppointmentsUpcomingFragment.Appointment appointment, int position) {
                ...
                accept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DocumentReference appointmentRef = db.collection("appointment").document(appointment.getDocumentID());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_therapist_appointment_pending, container, false);

        recyclerView = view.findViewById(R.id.pendingAppointmentsList);
